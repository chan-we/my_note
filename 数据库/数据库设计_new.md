[数据库怎么设计多对多的数据表](https://www.cnblogs.com/Renyi-Fan/p/9022574.html)
...
- 可以将常用信息和不常用信息分成两个表来优化数据库 
- 一对多的话：在多的里面建立一的字段，比如母亲和孩子，在孩子里面添加母亲id
- 多对多的话：比如老师和学生，建立一个关系表，表id，老师id，学生id即可